...
const getDefaultMaterials = (role: string) => {
  if (role === 'complaint') {
    return [{ name: '-', quantity: '-', remarks: '-' }];
  }
  return [{ name: '', quantity: '', remarks: '' }];
};
...
export function ComplaintForm({
  ...
  const [materials, setMaterials] = useState(
    complaint?.materialsUsed || getDefaultMaterials(currentUser?.role || '')
  );
  ...
  const form = useForm<ComplaintFormData>({
    ...
    defaultValues: {
      ...
      materialsUsed: complaint?.materialsUsed || getDefaultMaterials(currentUser?.role || ''),
            ...
            <FormField
              ...
              render={({ field }) => (
                <AppFormItem>
                  ...
                  <AppFormControl>
                    <Input type="date" {...field} id={field.name} name={field.name} className="bg-pink-100 dark:bg-zinc-800 text-pink-900 dark:text-pink-200" disabled={currentUser.role !== 'complaint' ? false : false} />
                  </AppFormControl>
                  <AppFormMessage />
                </AppFormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <AppFormItem>
                  ...
                  <AppFormControl>
                    <Input {...field} id={field.name} name={field.name} className="bg-yellow-100 dark:bg-zinc-800 text-yellow-900 dark:text-yellow-200" disabled={currentUser.role === 'complaint' ? false : false} />
                  </AppFormControl>
                  <AppFormMessage />
                </AppFormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <AppFormItem className="md:col-span-2">
                  ...
                  <AppFormControl>
                    <Input {...field} id={field.name} name={field.name} className="bg-purple-100 dark:bg-zinc-800 text-purple-900 dark:text-purple-200" disabled={currentUser.role === 'complaint' ? false : false} />
                  </AppFormControl>
                  <AppFormMessage />
                </AppFormItem>
              )}
                ...
                <AppFormItem>
                  ...
                  <AppFormControl>
                    <select
                      ...
                      disabled={currentUser.role === 'complaint' ? false : false}
                    >
                ...
                <AppFormItem>
                  ...
                  <AppFormControl>
                    <select
                      ...
                      required
                      disabled={currentUser.role === 'complaint'}
                    >
            ...
            <FormField
              ...
              render={({ field }) => (
                <AppFormItem>
                  ...
                  <AppFormControl>
                    <Input type="date" {...field} id={field.name} name={field.name} value={field.value || ''} disabled={currentUser.role === 'complaint'} />
                  </AppFormControl>
                  <AppFormMessage />
                </AppFormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <AppFormItem>
                  ...
                  <AppFormControl>
                    <Input {...field} id={field.name} name={field.name} value={field.value || ''} disabled={currentUser.role === 'complaint'} />
                  </AppFormControl>
                  <AppFormMessage />
                </AppFormItem>
              )}
                ...
                <div key={idx} className="flex gap-2 mb-2 items-center">
                  <div className="flex flex-col w-1/3">
                    ...
                    <Input
                      ...
                      value={currentUser.role === 'complaint' ? '-' : mat.name}
                      onChange={(e) => {
                        if (currentUser.role !== 'complaint') {
                  ...
                  <div className="flex flex-col w-1/4">
                    ...
                    <Input
                      ...
                      value={currentUser.role === 'complaint' ? '-' : mat.quantity}
                      onChange={(e) => {
                        if (currentUser.role !== 'complaint') {
                          const newMats = [...materials];
                  ...
                  <div className="flex flex-col w-1/3">
                    ...
                    <Input
                      ...
                      placeholder="Remarks"
                      value={currentUser.role === 'complaint' ? '-' : (mat.remarks || '')}
                      onChange={(e) => {
                        if (currentUser.role !== 'complaint') {
                          const newMats = [...materials];
                  ...
                  <Button
                    ...
                    disabled={materials.length === 1 || currentUser.role === 'complaint'}
                  >
                    Remove
                  </Button>
                </div>
